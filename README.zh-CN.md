...
| [migration-reviewer-generate](./migration-reviewer-generate/) | 适配器搬迁审查生成 meta-skill — 针对 re-host 场景（同一 adapter、宿主 A → B）产出双 oracle 的 review 检查清单 / skill / 规则块 / agent 主题 | [README](./migration-reviewer-generate/README.md) |
